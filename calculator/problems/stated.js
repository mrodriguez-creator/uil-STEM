...
const STATED_PROBLEMS = [
  ...
  { id: "s16", category: "stated", topic: "Calculus",
    ...
    hint: "<b>Slope of curve</b> (= derivative f&prime;(x)). f&prime;(x) = x<sup>2</sup>(x&minus;9)(5x&minus;27) via product rule. Type: (&minus;5)<sup>2</sup> &times; (&minus;5 &minus; 9) &times; (5(&minus;5) &minus; 27)"
  },
  { id: "s17", category: "stated", topic: "Calculus",
    ...
    hint: "<b>Area under curve</b> (= definite integral &int;). &int; = (15/&pi;)sin(&pi;(x&minus;2.5)/5). Evaluate: (15/&pi;)[sin(&pi;/2) &minus; sin(&minus;&pi;/2)] = 30 &divide; &pi;"
  },
  { id: "s24", category: "stated", topic: "Calculus",
    ...
    hint: "<b>Minimum</b> (= set derivative = 0 and solve). f&prime;(x) = 1/7 &minus; 7/x<sup>2</sup> = 0. Solve: x<sup>2</sup> = 49. Type: &radic;49"
  },
  { id: "s32", category: "stated", topic: "Calculus",
    ...
    hint: "<b>Area under curve</b> (= definite integral &int;). &int; = (15/&pi;)sin(&pi;(x&minus;2.5)/5). Evaluate: (15/&pi;) &times; 2 = 30 &divide; &pi;"
  },
  { id: "s58", category: "stated", topic: "Calculus",
    ...
    hint: "<b>Derivative</b> (= f&prime;(x), power rule: nx<sup>n&minus;1</sup>). f&prime;(x) = 12x<sup>3</sup> &minus; 4x + 7. Type: 12 &times; 1.5<sup>3</sup> &minus; 4 &times; 1.5 + 7"
  },
  { id: "s59", category: "stated", topic: "Calculus",
    ...
    hint: "<b>Integral</b> (= antiderivative, add 1 to exponent &divide; new exponent). &int; = x<sup>4</sup>/4 + x<sup>2</sup>. Evaluate at 2: 2<sup>4</sup> &divide; 4 + 2<sup>2</sup> = 4 + 4"
  },
  ...
  { id: "s44", category: "stated", topic: "Compound Interest",
    ...
    hint: "<b>Compounded monthly</b> (n = 12). A = P(1 + r/n)<sup>nt</sup>. Type: 5000 &times; (1 + 0.065 &divide; 12)<sup>36</sup>"
  },
  { id: "s45", category: "stated", topic: "Compound Interest",
    ...
    hint: "<b>Decays</b> (= &times; (1 &minus; rate) per period). M = M₀(1 &minus; r)<sup>t</sup>. Type: 800 &times; 0.958<sup>15</sup>"
  },
  ...
  { id: "s7", category: "stated", topic: "Conversion",
    ...
    hint: "<b>Volume ratio</b> (= (size ratio)<sup>3</sup> for spheres). Step 1: vol ratio = (15 &divide; 7)<sup>3</sup>. Step 2: trucks = 12000 &times; (15 &divide; 7)<sup>3</sup> &divide; 8500, round up"
  },
  ...
  { id: "s12", category: "stated", topic: "Dollar",
    ...
    hint: "<b>Total</b> (= add all products). Type: 35 &times; 0.25 + 24 &times; 0.10 + 59 &times; 0.05 + 134 &times; 0.01"
  },
  { id: "s50", category: "stated", topic: "Dollar",
    ...
    hint: "<b>Total cost</b> (= add each qty &times; price). Type: 3.5 &times; 2.49 + 2.0 &times; 1.89 + 4.0 &times; 0.59"
  },
  { id: "s51", category: "stated", topic: "Dollar",
    ...
    hint: "<b>Sales tax</b> (= price &times; (1 + rate)). Type: 87.50 &times; 1.0825"
  },
  ...
  { id: "s5", category: "stated", topic: "Geometry Word",
    ...
    hint: "<b>Periphery/Perimeter</b> (= distance around). Football field = 300 ft &times; 160 ft. Perimeter = 2 &times; (300 + 160)"
  },
  { id: "s9", category: "stated", topic: "Geometry Word",
    ...
    hint: "<b>Holds</b> (= volume). V = &pi;r<sup>2</sup>h, solve for h. Step 1: V = 700 &times; 231 in<sup>3</sup>. Step 2: r = 36 in. Type: 161700 &divide; (&pi; &times; 36<sup>2</sup>)"
  },
  { id: "s10", category: "stated", topic: "Geometry Word",
    ...
    hint: "<b>Circular area</b> (= &pi;r<sup>2</sup>), <b>circumference</b> (= 2&pi;r). Step 1: r = &radic;(40000 &divide; &pi;). Step 2: distance = 7 &times; 2&pi;r"
  },
  { id: "s22", category: "stated", topic: "Geometry Word",
    ...
    hint: "<b>Sum</b> (= add). Type: 53.4 + 34.9"
  },
  { id: "s56", category: "stated", topic: "Geometry Word",
    ...
    hint: "<b>Volume of cylinder</b> (= &pi;r<sup>2</sup>h). r = diameter &divide; 2 = 12. Type: &pi; &times; 12<sup>2</sup> &times; 5"
  },
  { id: "s57", category: "stated", topic: "Geometry Word",
    ...
    hint: "<b>Longest rod</b> (= space diagonal = &radic;(l<sup>2</sup> + w<sup>2</sup> + h<sup>2</sup>)). Type: &radic;(12.0<sup>2</sup> + 8.50<sup>2</sup> + 6.25<sup>2</sup>)"
  },
  ...
  { id: "s19", category: "stated", topic: "Integer",
    ...
    hint: "Translate words into equations. Let g = girls, b = g+13, m = g+41, w = g+68. Type: (210 &minus; 122) &divide; 4"
  },
  { id: "s48", category: "stated", topic: "Integer",
    ...
    hint: "<b>Remainder</b> (= what's left after dividing evenly). Step 1: 5620 &divide; 18.7 = 300.534… take integer part 300. Step 2: Type: 5620 &minus; 300 &times; 18.7"
  },
  { id: "s49", category: "stated", topic: "Integer",
    ...
    hint: "<b>Remainder</b> (= what's left after dividing evenly). Step 1: 8410 &divide; 6.61 = 1272.16… take integer part 1272. Step 2: Type: 8410 &minus; 1272 &times; 6.61"
  },
  ...
  { id: "s18", category: "stated", topic: "Matrix",
    ...
    hint: "<b>Matrix scalar multiply</b> (= multiply each element by scalar). J₃₃ = 3 &times; K₃₃ + 4 &times; L₃₃. Type: 3 &times; 6 + 4 &times; 5"
  },
  { id: "s34", category: "stated", topic: "Matrix",
    ...
    hint: "<b>Determinant</b> (3&times;3: expand along row/column using cofactors). Expand row 1, collect terms in c, set det = &minus;20, solve for c"
  },
  { id: "s60", category: "stated", topic: "Matrix",
    ...
    hint: "<b>Determinant</b> (2&times;2: ad &minus; bc). Type: 5.3 &times; 8.6 &minus; (&minus;2.1) &times; 4.7"
  },
  ...
  { id: "s31", category: "stated", topic: "Mixed Advanced",
    ...
    hint: "<b>Equals</b> (= set both sides equal &amp; solve). Trial and error: try x, compare 3<sup>x</sup> vs 5x. Try x = 0.269: 3<sup>0.269</sup> &asymp; 1.345, 5 &times; 0.269 = 1.345"
  },
  ...
  { id: "s15", category: "stated", topic: "Optimization",
    ...
    hint: "<b>Minimizes</b> (= set derivative of cost = 0). dC/dr = 8&pi;r &minus; V/r<sup>2</sup> = 0. Gives V = 8&pi;r<sup>3</sup>, so h = 8r. <b>Ratio</b> (= &divide;): h/d = 8r &divide; 2r = 4"
  },
  { id: "s33", category: "stated", topic: "Optimization",
    ...
    hint: "<b>Maximizes area</b> (= set derivative = 0). <b>Ratio</b> (= &divide;). x-intercept = 2a = 12, y-intercept = 2b = 7. Type: 12 &divide; 7"
  },
  ...
  { id: "s3", category: "stated", topic: "Percent",
    ...
    hint: "<b>Percent increase</b> (= (new &minus; old) &divide; old &times; 100). Type: (1500 &minus; 689) &divide; 689 &times; 100"
  },
  { id: "s23", category: "stated", topic: "Percent",
    ...
    hint: "<b>Profit</b> (= revenue &minus; cost). Step 1: profit/dozen = 12 &times; 1.25 &minus; 11 = 4. Step 2: Type: 100 &divide; 4"
  },
  { id: "s46", category: "stated", topic: "Percent",
    ...
    hint: "<b>Discounted</b> (= price &times; (1 &minus; rate)). Type: 42.50 &times; 0.65"
  },
  { id: "s47", category: "stated", topic: "Percent",
    ...
    hint: "<b>Percent increase</b> (= (new &minus; old) &divide; old &times; 100). Type: (15800 &minus; 12400) &divide; 12400 &times; 100"
  },
  ...
  { id: "s2", category: "stated", topic: "Rate",
    ...
    hint: "<b>Tax</b> (= price &times; (1 + rate)), <b>tip</b> (= subtotal &times; (1 + rate)). Step 1: subtotal = 18.45 &times; 1.08125. Step 2: total = subtotal &times; 1.18"
  },
  { id: "s4", category: "stated", topic: "Rate",
    ...
    hint: "<b>Distance to horizon</b> (= &radic;(1.5 &times; height in ft)). Type: &radic;(1.5 &times; 29032)"
  },
  { id: "s6", category: "stated", topic: "Rate",
    ...
    hint: "<b>Of</b> (= &times;). Recommended wt = 145 &times; 0.20. Water wt = 1.5 &times; 8.34. Type: 145 &times; 0.20 &minus; 1.5 &times; 8.34"
  },
  { id: "s11", category: "stated", topic: "Rate",
    ...
    hint: "<b>Fraction</b> (= part &divide; whole &times; 100 for %). Type: (3 + 16 &divide; 60) &divide; 16 &times; 100"
  },
  { id: "s13", category: "stated", topic: "Rate",
    ...
    hint: "<b>Velocity</b> (= distance &divide; time). Circumference = &pi; &times; d. Type: &pi; &times; 550 &divide; 0.5 &divide; 5280 (ft/hr &rarr; mph)"
  },
  { id: "s14", category: "stated", topic: "Rate",
    ...
    hint: "<b>Free-fall time</b> (= &radic;(2h &divide; g)). Step 1: t = &radic;(2 &times; 6.5 &divide; 32.2). Step 2: 20 mph = 29.33 ft/s. <b>Distance</b> (= speed &times; time). Type: 29.33 &times; t"
  },
  { id: "s21", category: "stated", topic: "Rate",
    ...
    hint: "<b>Laps</b> (= Tom goes 1 full lap more). <b>Speed</b> (= dist &divide; time). Step 1: Tom speed = 1760 &divide; 6.5 yd/min. Step 2: Tom dist in 4.643 min. Step 3: Alan dist = Tom dist &minus; 440. Step 4: mile time = 1760 &divide; (Alan dist &divide; 4.643)"
  },
  { id: "s25", category: "stated", topic: "Rate",
    ...
    hint: "Opposite directions: distances <b>add</b> to 440. Gabe ran 440 &minus; 275 = 165 yd/min. <b>Convert</b>: Type: 165 &times; 60 &divide; 1760"
  },
  { id: "s27", category: "stated", topic: "Rate",
    ...
    hint: "<b>Surface velocity</b> (= equatorial speed &times; cos(lat)). cos(lat) = 500 &divide; 1037.6. Type: cos<sup>&minus;1</sup>(500 &divide; 1037.6)"
  },
  { id: "s28", category: "stated", topic: "Rate",
    ...
    hint: "<b>Arrive same time</b> (= set travel times equal). Step 1: Debby time = 74 &divide; 55 hr. Step 2: Megan time = Debby time &minus; 19.7/60. Step 3: <b>Distance</b> (= speed &times; time) = 58 &times; Megan time. Total = Megan dist + 74"
  },
  { id: "s29", category: "stated", topic: "Rate",
    ...
    hint: "<b>Ratio</b> (= a &divide; b). Volume &prop; d<sup>3</sup>, so <b>d ratio</b> = (V ratio)<sup>1/3</sup>. Type: (3 &divide; 4)<sup>(1/3)</sup>"
  },
  { id: "s35", category: "stated", topic: "Rate",
    ...
    hint: "<b>Inversely proportional</b> (= I &prop; 1/d<sup>2</sup>), <b>directly proportional</b> (= I &prop; W). Step 1: d₂ = &radic;(100 &times; 36 &divide; 150). Step 2: Type: 6 &minus; &radic;(100 &times; 36 &divide; 150)"
  },
  { id: "s36", category: "stated", topic: "Rate",
    ...
    hint: "<b>Percent error</b> (= (approx &minus; actual) &divide; actual &times; 100). Step 1: straight time = 230 &divide; 200. Step 2: find actual trajectory time using projectile equations. Step 3: % error = (straight &minus; actual) &divide; actual &times; 100"
  },
  { id: "s54", category: "stated", topic: "Rate",
    ...
    hint: "<b>Average speed</b> (= total distance &divide; total time). Type: 245 &divide; 3.75"
  },
  { id: "s55", category: "stated", topic: "Rate",
    ...
    hint: "Opposite directions: speeds <b>add</b>. <b>Time</b> (= distance &divide; speed). Type: 381 &divide; (55 + 72)"
  },
  ...
  { id: "s20", category: "stated", topic: "SD",
    ...
    hint: "<b>Density</b> (= mass &divide; volume), so height = mass &divide; (area &times; density). Round to <b>least sig figs</b> in given data. Type: 12478.16 &divide; (4.633 &times; 160)"
  },
  { id: "s26", category: "stated", topic: "SD",
    ...
    hint: "<b>Assuming % lost</b> (= &times; (1 &minus; rate)). Convert ft<sup>3</sup> to in<sup>3</sup> (&times; 1728). Type: 52508 &times; 0.67 &times; 1728 &divide; 0.0050"
  },
  { id: "s52", category: "stated", topic: "SD",
    ...
    hint: "<b>Significant digits</b>: leading zeros don't count; trailing zeros after decimal DO count. Count: 4, 5, 7, 0 = 4"
  },
  { id: "s53", category: "stated", topic: "SD",
    ...
    hint: "<b>Product</b> (= &times;). <b>2 SD</b>: round answer to 2 significant digits. Type: 3.14 &times; 9.876, then round to 2 SD"
  },
  ...
  { id: "s8", category: "stated", topic: "Statistics",
    ...
    hint: "<b>Slope of best-fit line</b> (= linear regression m). Use STAT mode: enter data pairs (2,1)(3,2)(4,3)(5,5)(6,8), read slope m"
  },
  { id: "s30", category: "stated", topic: "Statistics",
    ...
    hint: "<b>Correlation coefficient</b> (= r, measures linear fit, &minus;1 to 1). Use STAT mode: enter data pairs (1,14)(2,29)(3,31)(4,42)(5,50), read r"
  },
  ...
  { id: "s37", category: "stated", topic: "Translation",
    ...
    hint: "<b>Average</b> (= add all &divide; count). Type: (45.7 + 93.2 + 14.9) &divide; 3"
  },
  { id: "s38", category: "stated", topic: "Translation",
    ...
    hint: "<b>Square root</b> (= &radic;), <b>product</b> (= &times;). Type: &radic;(34.6 &times; 6.3<sup>3</sup>)"
  },
  { id: "s39", category: "stated", topic: "Translation",
    ...
    hint: "<b>Of</b> (= &times;), <b>sum</b> (= add all). Type: 0.356 &times; (12.8 + 21.4 + 16.5)"
  },
  { id: "s40", category: "stated", topic: "Translation",
    ...
    hint: "<b>Product</b> (= &times;), <b>positive difference</b> (= |a &minus; b|). Type: 3.96 &times; 736"
  },
  { id: "s41", category: "stated", topic: "Translation",
    ...
    hint: "<b>Times</b> (= &times;), <b>cube</b> (= raise to 3rd power). Step 1: x<sup>3</sup> = &minus;345.9 &divide; 18.4. Step 2: x = (&minus;18.80)<sup>(1/3)</sup>. Step 3: Type: 3 &times; x"
  },
