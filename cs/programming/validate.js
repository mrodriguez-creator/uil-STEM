...
const files = ['starter.js', 'basics.js', 'easy.js', 'intermediate.js', 'medium.js', 'prehard.js', 'hard.js', 'advanced.js'];
const constants = ['STARTER_PROBLEMS', 'BASICS_PROBLEMS', 'EASY_PROBLEMS', 'INTERMEDIATE_PROBLEMS', 'MEDIUM_PROBLEMS', 'PREHARD_PROBLEMS', 'HARD_PROBLEMS', 'ADVANCED_PROBLEMS'];
